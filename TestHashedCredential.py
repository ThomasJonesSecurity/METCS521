...
class TestHashedCredentials(unittest.TestCase):
    ...
    def test_HashedCredential_init_(self):
        test_good_record = HashedCredential.HashedCredential(
            username='admin',
        ...
        test_bad_hash_record = HashedCredential.HashedCredential(
            username='admin',
            ntlm_hash='TESTBAdData8846F7EAEE8FB117AD06BDD830B7586C',
            lm_hash='E52CAC67419A9A224A3B108F3FA6CB6D')
        self.assertFalse(test_bad_hash_record.valid_hashes)
        self.assertEqual(
            test_bad_hash_record.status,
            'NTLM hash length or character invalid')

    def test_HashedCredential_cracked(self):
        test_crack_record = HashedCredential.HashedCredential(
            username='admin',
            ntlm_hash='8846F7EAEE8FB117AD06BDD830B7586C',
            lm_hash='E52CAC67419A9A224A3B108F3FA6CB6D')
