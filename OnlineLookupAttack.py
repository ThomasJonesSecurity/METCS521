...
# http://api.leakdb.net. The returned json if found, will contain the plaintext plaintext of the posted hash.
...
def get_url(a_queue, a_url):
    ...
    # Post 2: HTTPError printed to console if not first occurrence of HTTPError 429
...
def online_hash_lookup_by_leakedb_api(accounts_list):
    ...
    # Post Condition: ntlm_urls and lm_urls populated lists of api_urls to get for threaded request
    # Post Condition: each url is requested in thread and json response added to json_queue
